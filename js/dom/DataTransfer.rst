...
.. py:class:: DataTransfer()
    ...
    .. py:attribute:: files
        ...
        Ес­ли пе­ре­ме­щае­мые дан­ные яв­ля­ют­ся од­ним или бо­лее фай­ла­ми, 
        это свой­ст­во бу­дет ссы­лать­ся на мас­сив или на объ­ект, 
        по­доб­ный мас­си­ву, со­дер­жа­щий объ­ек­ты File.
